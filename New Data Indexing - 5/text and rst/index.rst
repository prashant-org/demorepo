...
Neural Tangents (`neural_tangents` -- `nt`) is a set of tools for constructing and training infinitely wide
...
.. toctree::
   :maxdepth: 2
   :caption: Colab Examples:

   Cookbook <https://colab.research.google.com/github/google/neural-tangents/blob/main/notebooks/neural_tangents_cookbook.ipynb>
